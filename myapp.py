...
p.add_run('Handling data in different methodologies: managing the tech inventory and data analysis with the use of advanced software programs such as Sql, Python, Ms Excell, and various Data Visualization tools (PowerBi, Tableau).\n')
